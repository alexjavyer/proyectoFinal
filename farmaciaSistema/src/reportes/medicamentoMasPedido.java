 ...
 * @author Javy
 */
public class medicamentoMasPedido extends javax.swing.JInternalFrame {

    /**
     * Creates new form medicamentoMasPedido
     */
    public medicamentoMasPedido() {
        initComponents();
        medicamentoMasPedido();
        setBounds(500, 200, 400, 160);
        getContentPane().setBackground(new java.awt.Color(12,10,204));
        setTitle("M E D I C A M E N T O  M Á S  P E D I D O");
    }
    
    void medicamentoMasPedido(){       
                conexion cc = new conexion();
                Connection cn = cc.conectar();      
                int contar=0;
                String nombre="";
                String sql = "";
                sql="SELECT COD_MED_V as nombre, COUNT(CANT_ven) as contar\n" +
                    "FROM DETALLES_VENTAS\n" +
                    "GROUP BY COD_MED_V\n" +
                    "HAVING COUNT(CANT_VEN) = (SELECT COUNT(CANT_VEN)\n" +
                    "			    FROM DETALLES_VENTAS\n" +
                    "			    GROUP BY COD_med_v\n" +
                    "	                    ORDER BY COUNT(CANT_VEN)DESC\n" +
                    "	                    LIMIT 1)";
                  try {
  ...
  //  String dir1="C:\\ReportesFinal\\";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MEDICAMENTO MÁS VENDIDO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(medicamentoMasPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new medicamentoMasPedido().setVisible(true);
            }
        });
    }
